...
<!-- ===== SEO META TAGS ===== -->
<title>EduBuild — Eco Green Engineering Hub by Modou Jaw</title>
<meta name="description" content="EduBuild is a free AI-powered engineering project idea generator and mentor. Created by Modou Jaw, Electrical Engineering student at USET. Powered by Eco Green — the energy that moves with you." />
<meta name="keywords" content="engineering project ideas, eco green, Modou Jaw, USET, electrical engineering, civil engineering, mechanical engineering, AI mentor, student projects, green engineering, EduBuild" />
<meta name="author" content="Modou Jaw" />
<meta name="robots" content="index, follow" />
<link rel="canonical" href="https://moodoujaw.github.io/edubuild/" />

<meta property="og:type" content="website" />
<meta property="og:title" content="EduBuild — Eco Green Engineering Hub by Modou Jaw" />
<meta property="og:description" content="Free AI-powered engineering project ideas and mentoring for students. Created by Modou Jaw — Electrical Engineering student at USET." />
<meta property="og:url" content="https://moodoujaw.github.io/edubuild/" />
<meta property="og:image" content="https://moodoujaw.github.io/edubuild/og-image.png" />
<meta property="og:site_name" content="EduBuild — Eco Green" />
<meta property="og:locale" content="en_GB" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="EduBuild — Eco Green Engineering Hub" />
<meta name="twitter:description" content="AI-powered engineering project ideas & mentoring for students. By Modou Jaw, USET. Free to use!" />
<meta name="twitter:image" content="https://moodoujaw.github.io/edubuild/og-image.png" />
...
<script type="application/ld+json">
{
  ...
  "author": {
    ...
    "affiliation": { "@type": "EducationalOrganization", "name": "University of Applied Science Engineering and Technology (USET)" }
  }
}
</script>
...
:root {
  ...
  --navbar-bg: rgba(245,251,247,0.93);
  --manifesto-bg: linear-gradient(135deg,#edfaf3,#f0faf5);
  --modal-overlay: rgba(10,30,20,0.55);
}
...
[data-theme="dark"] {
  ...
  --navbar-bg: rgba(14,24,18,0.95);
  --manifesto-bg: linear-gradient(135deg,#0a2a1d,#0e1f18);
  --modal-overlay: rgba(0,0,0,0.75);
}

/* ===== TRANSITIONS ===== */
*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
body, .api-modal, .how-card, .field-card, .level-card, .idea-card,
.saved-card, .bubble, .chat-ta, .topic-btn, .pill, .fbadge,
.team-btn, footer, #navbar, .manifesto, .founder-card,
#api-status-bar, .gemini-banner {
...
.theme-toggle:hover {
  border-color:var(--green); background:var(--green4);
...
.api-modal {
  ...
  border:1.5px solid var(--border); animation:slideUp 0.35s ease; text-align:center;
}
@keyframes slideUp { from{opacity:0;transform:translateY(30px)} to{opacity:1;transform:translateY(0)} }

.modal-gemini-icon { font-size:52px; margin-bottom:16px; display:block; animation:floatBounce 3s ease-in-out infinite; }
.modal-title { font-family:'Lora',serif; font-size:24px; font-weight:700; color:var(--text); margin-bottom:8px; }
.modal-sub { font-size:14px; color:var(--text3); line-height:1.75; margin-bottom:24px; font-weight:600; }
.modal-input-wrap { position:relative; margin-bottom:12px; }
.modal-input {
  width:100%; padding:14px 48px 14px 16px; border-radius:14px;
  border:1.5px solid var(--border2); background:var(--bg);
  font-family:'Nunito',sans-serif; font-size:14px; color:var(--text);
  outline:none; font-weight:600; transition:border-color 0.2s, background 0.3s, color 0.3s;
  letter-spacing:0.5px;
}
.modal-input:focus { border-color:var(--blue); box-shadow:0 0 0 3px #4285f418; }
.modal-input::placeholder { color:var(--text3); letter-spacing:0; }
.modal-eye {
  position:absolute; right:14px; top:50%; transform:translateY(-50%);
  background:none; border:none; cursor:pointer; font-size:16px; color:var(--text3); padding:4px;
}
.modal-eye:hover { color:var(--green); }
.modal-hint { font-size:12px; color:var(--text3); margin-bottom:20px; font-weight:600; text-align:left; line-height:1.6; }
.modal-hint a { color:var(--blue); text-decoration:none; font-weight:700; }
...
.modal-save-btn {
  ...
  cursor:pointer; transition:all 0.25s; box-shadow:0 6px 24px #4285f444;
  display:flex; align-items:center; justify-content:center; gap:8px; margin-bottom:12px;
}
.modal-save-btn:hover { transform:translateY(-2px); box-shadow:0 10px 32px #4285f455; }
.modal-skip { font-size:12px; color:var(--text3); cursor:pointer; font-weight:700; background:none; border:none; font-family:'Nunito',sans-serif; }
.modal-skip:hover { color:var(--green); text-decoration:underline; }
.modal-security {
  display:flex; align-items:center; gap:8px; margin-top:16px;
  padding:10px 14px; background:var(--green4); border-radius:10px; border:1px solid var(--green3);
}
.modal-security-icon { font-size:16px; flex-shrink:0; }
.modal-security-text { font-size:11px; color:var(--text2); font-weight:600; text-align:left; line-height:1.5; }
...
#api-status-bar:hover { box-shadow:var(--shadow2); transform:translateY(-2px); }
.status-indicator { width:8px; height:8px; border-radius:50%; flex-shrink:0; }
.status-indicator.active { background:var(--green2); animation:pulse 2s infinite; }
.status-indicator.inactive { background:#f59e0b; }
...
#navbar {
  ...
  background:var(--navbar-bg); backdrop-filter:blur(18px);
  border-bottom:1px solid var(--border); box-shadow:0 2px 16px rgba(26,158,92,0.07);
}
...
[data-theme="dark"] .s1 { background:radial-gradient(circle,#0d3324,transparent 70%); }
[data-theme="dark"] .s2 { background:radial-gradient(circle,#0a1f2e,transparent 70%); }
[data-theme="dark"] .s3 { background:radial-gradient(circle,#1e1a08,transparent 70%); }
[data-theme="dark"] .dots { opacity:0.08; }
...
/* ===== MANIFESTO ===== */
.manifesto { padding:80px 36px; text-align:center; background:var(--manifesto-bg); border-top:1px solid var(--border); border-bottom:1px solid var(--border); }
...
/* ===== FOUNDER ===== */
.team-section { padding:80px 36px; max-width:860px; margin:0 auto; text-align:center; }
.founder-card { background:var(--surface); border:1.5px solid var(--border); border-radius:28px; padding:40px 36px; display:grid; grid-template-columns:auto 1fr; gap:28px; align-items:start; box-shadow:var(--shadow); max-width:700px; margin:32px auto 0; transition:all 0.28s; text-align:left; }
.founder-card:hover { box-shadow:var(--shadow2); transform:translateY(-4px); }
.founder-left { display:flex; flex-direction:column; align-items:center; gap:12px; min-width:120px; }
.founder-ava { width:90px; height:90px; border-radius:50%; background:linear-gradient(135deg,var(--green),var(--green2)); display:flex; align-items:center; justify-content:center; font-size:40px; box-shadow:0 6px 24px #1a9e5c44; }
.founder-role-pill { font-size:11px; color:var(--green); font-weight:800; background:var(--green3); padding:5px 12px; border-radius:50px; text-align:center; line-height:1.4; }
.founder-right h3 { font-family:'Lora',serif; font-size:22px; font-weight:700; color:var(--text); margin-bottom:6px; }
.founder-uni { display:flex; align-items:center; gap:6px; font-size:13px; color:var(--green); font-weight:800; margin-bottom:14px; }
.founder-bio { font-size:14px; color:var(--text2); line-height:1.9; font-weight:600; margin-bottom:18px; }
.founder-badges { display:flex; flex-wrap:wrap; gap:8px; }
.fbadge { padding:6px 14px; border-radius:20px; border:1.5px solid var(--border2); background:var(--bg); color:var(--text2); font-size:12px; font-weight:700; }
.team-btns { display:flex; gap:10px; flex-wrap:wrap; justify-content:center; margin-top:24px; }
...
.gemini-banner { display:flex; align-items:center; gap:12px; padding:14px 18px; border-radius:14px; background:linear-gradient(135deg,#e8f4fd,#e3f6ec); border:1.5px solid #bbd8f5; margin-bottom:28px; cursor:pointer; transition:all 0.2s; }
.gemini-banner:hover { box-shadow:var(--shadow); }
[data-theme="dark"] .gemini-banner { background:linear-gradient(135deg,#0a1a2e,#0a2a1d) !important; border-color:#1e3a5a !important; }
.gemini-logo { font-size:22px; }
.gemini-banner-text { flex:1; font-size:13px; color:#1a3a5c; font-weight:700; }
[data-theme="dark"] .gemini-banner-text { color:var(--text2) !important; }
.gemini-banner-sub { font-size:11px; color:#5a7a9c; font-weight:600; }
[data-theme="dark"] .gemini-banner-sub { color:var(--text3) !important; }
.gemini-banner-action { font-size:12px; color:var(--blue); font-weight:800; white-space:nowrap; }
...
.chat-ta { flex:1; background:var(--surface); border:1.5px solid var(--border); border-radius:16px; padding:13px 17px; color:var(--text); font-family:'Nunito',sans-serif; font-size:14px; resize:none; outline:none; line-height:1.6; max-height:110px; overflow-y:auto; transition:border-color 0.2s, background 0.3s, color 0.3s; font-weight:600; }
...
.send-btn.ready:hover { transform:translateY(-2px); }
...
@media(max-width:640px){
  ...
  .founder-left { margin:0 auto; }
  #api-status-bar { bottom:12px; right:12px; font-size:11px; padding:8px 12px; }
}
</style>
</head>
<body>
...
<div id="api-modal-overlay">
  <div class="api-modal">
    ...
    <p class="modal-sub">
      ...
      Enter your free API key below to get started — it stays on your device only.
    </p>
    ...
    <br/>
    <button class="modal-skip" onclick="skipApiKey()">Skip for now (limited features)</button>
    <div class="modal-security">
      <span class="modal-security-icon">🔒</span>
      <span class="modal-security-text">Your key is stored only in your browser's local storage and is never sent to our servers. Only you have access to it.</span>
    </div>
  </div>
</div>

<!-- ===== API STATUS BAR ===== -->
<div id="api-status-bar" onclick="openApiModal()" title="Click to change API key">
  <div class="status-indicator inactive" id="status-dot"></div>
...
<section id="hero-page" class="page active">
  ...
  <div class="team-section">
    ...
    <div class="founder-card">
      <div class="founder-left">
        <div class="founder-ava">👨‍💻</div>
        <div class="founder-role-pill">🌿 Team Leader<br/>Eco Green</div>
      </div>
      <div class="founder-right">
        <h3>Modou Jaw</h3>
        <div class="founder-uni">🎓 &nbsp;Electrical &amp; Electronics Engineering · USET</div>
        <p class="founder-bio">
          Modou Jaw is a passionate <strong>3rd Year, 2nd Semester</strong> Electrical and Electronics Engineering student at the <strong>University of Applied Science Engineering and Technology (USET)</strong> — and the visionary team leader behind Eco Green.
          <br/><br/>
          He built EduBuild with heart, purpose, and a deep belief that students everywhere can engineer a better, greener world. His mission: make high-quality engineering education accessible to every student, no matter where they are.
        </p>
  ...
  <footer>
    ...
    <div class="foot-credit">Created with 💚 by <span>Modou Jaw</span> · Electrical &amp; Electronics Engineering Student · <span>USET</span></div>
    <div class="foot-nav">
      <a onclick="showPage('app')">Generate Ideas</a>
      <a onclick="showPage('chat')">Eco Green AI</a>
      <a onclick="showPage('saved')">Saved Projects</a>
    </div>
    <div class="foot-copy">© 2025 EduBuild · Eco Green Engineering Hub · Powered by Google Gemini AI</div>
  </footer>
</section>
...
<section id="app-section" class="page">
  <div class="app-wrap">
    ...
    <div class="gemini-banner" id="gemini-banner" onclick="openApiModal()">
      ...
      <div>
        <div class="gemini-banner-text" id="banner-title">Gemini API Key Required</div>
        <div class="gemini-banner-sub" id="banner-sub">Click here to add your free Gemini API key and unlock idea generation</div>
      </div>
      <span class="gemini-banner-action" id="banner-action">Set Key →</span>
    </div>
  ...
  <div class="chat-wrap">
    ...
    <div class="chat-input-bar">
      <textarea class="chat-ta" id="chat-in" rows="1"
        ...
        onkeydown="chatKey(event)" oninput="resizeTA(this)"></textarea>
...
const const GEMINI_URL='https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent';
...
function renderIdeas(){
  ...
  ideas.forEach((idea,i)=>{
    ...
    d.innerHTML=`
      ...
      <div class="idea-body">
        <div class="idea-meta" style="color:${f.color}">IDEA ${i+1} &nbsp;·&nbsp; ${'⭐'.repeat(diff)}${'☆'.repeat(5-diff)}</div>
...
function confetti(){
  ...
  for(let i=0;i<32;i++){
    ...
    const sz=7+Math.random()*8,isCircle=Math.random()>0.5;
